// Modified from https://github.com/trekhleb/trekhleb.github.io/blob/7b151f8ac9024c24b1df818f9308bcaf2d354943/src/posts/2021/gyro-web/components/OrientationSwitcher.tsx
  ...
  const onToggle = (toggleState: boolean): void => {
    if (toggleState) {
      requestAccess().then((granted: boolean) => {
        setOrientationAvailable(granted)
      })
    } else {
      revokeAccess().then(() => {
